          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                  <img src="images/women.jpg" class="img-thumbnail grayscale" id="myBtn">
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                  ...
                  <img src="images/women2.jpg" class="img-thumbnail grayscale" id="myBtn2">
                  <figcaption>Leather Sandals<br>$89.60</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women3.jpg" class="img-thumbnail grayscale" id="myBtn3">
                  <figcaption>Flats<br>$89.60</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(4).jpg" class="img-thumbnail grayscale" id="myBtn4">
                  <figcaption>Slippers<br>$60.89</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(5).jpgg" class="img-thumbnail grayscale" id="myBtn5">
                  <figcaption>Leather Flats<br>$89.60</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(6).jpg" class="img-thumbnail grayscale" id="myBtn6">
                  <figcaption>Sandal<br>$79.80</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(7).jpg" class="img-thumbnail grayscale" id="myBtn7">
                  <figcaption>Leather Heels<br>$90.70</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(8).jpg" class="img-thumbnail grayscale" id="myBtn8">
                  <figcaption>Leather Heels with Strap<br>$90.70</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(10).jpg" class="img-thumbnail grayscale" id="myBtn9">
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(11).jpg" class="img-thumbnail grayscale" id="myBtn10">
                  <figcaption>Heels<br>$89.70</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(12).jpg" class="img-thumbnail grayscale" id="myBtn11">
                  <figcaption>House Slipper<br>$60.90</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(13).jpg" class="img-thumbnail grayscale" id="myBtn12">
                  <figcaption>Shoes<br>$89.60</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(14).jpgg" class="img-thumbnail grayscale" id="myBtn13">
                  <figcaption>Heels<br>$89.70</figcaption>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                <figure>
                   <!-- Trigger/Open The Modal -->
                  <img src="images/women(15).jpg" class="img-thumbnail grayscale" id="myBtn14">
                  <figcaption>High Heels<br>$92.70</figcaption>
